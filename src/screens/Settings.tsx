...
const Settings = () => {
    ...
    return (
        <Layout>
            <ScrollView style={[styles.contentContainer, { backgroundColor: theme.layoutBg }]}>
                <Card style={{ backgroundColor: theme.cardBg }}>
                    ...
                    <>
                        ...
                        <MenuItem label="Clear History" onPress={() => console.log('here')} />
                        ...
                        />
                        <MenuItem label="Terms & Conditions" onPress={() => console.log('here')} />
